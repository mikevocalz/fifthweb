import { Image } from "app/design/layout"

const FooterComponent = () => {
  return (

    <footer className="bg-white sm:p-0 dark:bg-black relative">
      <div className="py-6 px-10 md:flex md:justify-between">
        <div className=" mb-6 md:mb-0">
          <a href="https://flowbite.com/" className="flex items-center">
            <img src={require("../../../apps/expo/assets/images/fifth-logo.svg")}
              className=' object-cover object-left h-20 mr-3'
              alt="Fifth Galaxy Studios Logo" />
            <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Fifth Galaxy Studios</span>
          </a>
        </div>
        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
          <div>
            ...
            <ul className="text-gray-600 dark:text-gray-400">
              <li className="mb-4">
                <a href="https://flowbite.com/" className="hover:underline">Android</a>
              </li>
              <li>
                <a href="https://tailwindcss.com/" className="hover:underline">iOS</a>
              </li>
            </ul>
          </div>
          <div>
      ...
      <div className="px-4 py-6 bg-[#93278F] md:flex md:items-center md:justify-between">
        <span className="font-bold text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2023 <a href="https://flowbite.com/">Fifth Galaxy Studios™</a>. All Rights Reserved.
        </span>
